...
{
    public class AccLeaderboardController : PlayerLeaderboardController
    {
        private const string FILENAME = @"AccLeaderboard";
        private const string LEADERBOARD_TYPE = "acc";
        private static readonly string s_PointName = ConfigController.GetConfig().AccPointsName;
