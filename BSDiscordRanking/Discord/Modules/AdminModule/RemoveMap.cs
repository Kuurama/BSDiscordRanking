            ...
            else
            {
                if (p_DifficultyName is "Easy" or "Normal" or "Hard" or "Expert" or "ExpertPlus")
                {
                    if (p_Characteristic is "Lawless" or "Standard" or "90Degree" or "360Degree")
                    {
                        ...
                        LevelController.MapExistFormat l_MapExistCheck = new LevelController().MapExist_Check(l_Map.versions[^1].hash, p_DifficultyName, p_Characteristic, 0, null, null, null, 1f);
